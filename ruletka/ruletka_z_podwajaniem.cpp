...
int stawki::doini()
{
    ...
    WritePrivateProfileString(temp1, "Maksymalny depozyt", temp3, ".//stawki//globalny.ini");
    sprintf(temp3, "%i",depozyt_gmax*100/depozyt_poczatkowy);
    WritePrivateProfileString(temp1, "zysk w %", temp3, ".//stawki//globalny.ini");

    sprintf(temp4, ".//stawki//%i-%i.ini", depozyt_poczatkowy, stawka_poczatkowa);
    sprintf(temp3, "%i", depozyt_gmax);
